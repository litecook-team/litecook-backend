...
INGREDIENTS_DATA = [
    ...
    ("Коричневий цукор", IngredientCategory.SWEETS, False, []),
    ("Цукрова пудра", IngredientCategory.SWEETS, False, []),
    ("Желатин", IngredientCategory.SPICES, False, []),
    ("Білий перець", IngredientCategory.SPICES, False, []),
    ("Рожевий перець", IngredientCategory.SPICES, False, []),
    ("Зелений перець", IngredientCategory.SPICES, False, []),
    ...
    ("Зелений горошок", IngredientCategory.VEGETABLES, False, []),
    ...
    ("Зелена цибуля", IngredientCategory.GREENS, False, []),
