...
INGREDIENTS_DATA = [
    ...
    ("Капуста брюссельська", IngredientCategory.VEGETABLES, True, [9, 10, 11]),
    ...
    ("Квасоля зелена", IngredientCategory.VEGETABLES, True, [7, 8, 9]),
    ...
    ("Корінь селери", IngredientCategory.VEGETABLES, True, [9, 10, 11]),
    ...
    ("Селера (стебла)", IngredientCategory.VEGETABLES, True, [9, 10, 11]),
    ...
    ("Рис білий", IngredientCategory.GRAINS, False, []),
    ("Гречка", IngredientCategory.GRAINS, False, []),
    ("Рис дикий", IngredientCategory.GRAINS, False, []),
    ("Рис коричневий", IngredientCategory.GRAINS, False, []),
    ...
    # ================= ІНГРЕДІЄНТИ =================
    ("Телячий язик", IngredientCategory.MEAT_OTHER, False, []),
    ("Цукор коричневий", IngredientCategory.SWEETS, False, []),
    ("Цукрова пудра", IngredientCategory.SWEETS, False, []),
    ("Желатин", IngredientCategory.SPICES, False, []),
    ("Перець білий", IngredientCategory.SPICES, False, []),
    ("Перець рожевий", IngredientCategory.SPICES, False, []),
    ("Перець зелений", IngredientCategory.SPICES, False, []),
    ("Перець чилі", IngredientCategory.SPICES, False, []),
    ("Кедрові горіхи", IngredientCategory.NUTS, False, []),
    ("В'ялені томати", IngredientCategory.VEGETABLES, False, []),
    ("Бренді", IngredientCategory.OILS_LIQUIDS, False, []),
    ("Свинина", IngredientCategory.MEAT_PORK, False, []),
    ("Раки", IngredientCategory.SEAFOOD, False, []),
    ("Горошок зелений", IngredientCategory.VEGETABLES, False, []),
    ("Листя цикорію", IngredientCategory.VEGETABLES, False, []),
    ("Мікрогрін гороху", IngredientCategory.VEGETABLES, False, []),
    ("Цибуля-порей", IngredientCategory.VEGETABLES, False, []),
    ("Солоні огірки", IngredientCategory.VEGETABLES, False, []),
    ("Перепелині яйця", IngredientCategory.DAIRY, False, []),
    ("Чебрець", IngredientCategory.GREENS, False, []),
    ("Естрагон", IngredientCategory.GREENS, False, []),
    ("Лавровий лист", IngredientCategory.SPICES, False, []),
    ("Гірчиця", IngredientCategory.SPICES, False, []),
    ("Букет гарні", IngredientCategory.SPICES, False, []),
    ("Кістки червоної риби", IngredientCategory.FISH_RED, False, []),
    ("Перець чорний", IngredientCategory.SPICES, False, []),

    ("Листя карі", IngredientCategory.SPICES, False, []),
    ("Насіння чорної гірчиці", IngredientCategory.SPICES, False, []),
    ("Куркума", IngredientCategory.SPICES, False, []),
    ("Кмин", IngredientCategory.SPICES, False, []),
    ("Фенхель (насіння)", IngredientCategory.SPICES, False, []),
    ("Кокосове молоко", IngredientCategory.OILS_LIQUIDS, False, []),
    ("Пападам", IngredientCategory.GRAINS, False, []),
]
